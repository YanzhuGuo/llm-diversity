    ...
    for dir in directories:
        ...
        for fname in files:
            ...
            with open(fname) as f:
                ...
                sentence_embeddings = model.encode(sentences, batch_size=8, show_progress_bar=False, convert_to_tensor=True, normalize_embeddings=True)
