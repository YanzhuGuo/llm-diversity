...
output_file = 'unique-n_decoding.txt'

# List of directories to process
#directories = ['../story/outputs', '../story/olmo', '../story/scale', '../story/base', '../dialogue/outputs', '../summary/outputs', '../translation/outputs', '../wiki/outputs']
directories = ['../story/decoding']
...
with open(output_file, 'w') as f_out:
    for dir in directories:
        ...
        for fname in files:
            ...
            n_tokens = 40000 #modify according to dataset
            ...
            tokens = random.sample(tokens, n_tokens)
            bi_grams = random.sample(bi_grams, n_tokens)
            tri_grams = random.sample(tri_grams, n_tokens)
